        	...
        	<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
				...
				<div class="navbar-collapse collapse">
				  <ul class="nav navbar-nav navbar-right">
                    <li><a href="trainno">by <i class="fas fa-subway"></i> Train No</a></li>
                    <li><a href="trainstation">by From Station <i class="fas fa-exchange-alt"></i> To Station</a></li>
                    <li><a href="pro"><i class="fas fa-user"></i> View Profile</a></li>
                    <li><a href="edit"><i class="fas fa-edit"></i> Update Profile</a></li>
