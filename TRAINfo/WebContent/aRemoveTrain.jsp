...
%>
    ...
    <div class="text-center">
	    ...
	    <br>
	    <form action="aremovetrain" method="POST">
	        <div class="form-group">
	            <label for="tno">Train No :</label>
	            <input type="text" class="form-control" id="tno" placeholder="Enter Train Number" name="removeTrainNo" required>
	        </div>
...
<%
	if(request.getAttribute("notexists") != null)
	{
%>
	<div class="col-sm-offset-1 col-sm-5 well text-center" style="background-color:rgba(0, 0, 0, 0.7); color:rgba(255, 255, 255, 1);">
	    ...
	    <h2><%= request.getAttribute("notexists") %></h2>
	    <label for="tno">Please Enter Another Train No</label>
	    </div>
	    <br>
    </div>
<%
...
<!-- START DISPLAYING THE TRAIN DETAILS -->
	...
	<h2 class="text-center">TRAIN REMOVED SUCCESSFULLY</h2>
